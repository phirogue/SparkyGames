...
| [music-prompts.md](music-prompts.md) | Soundtrack identity, the 15 track prompts + 6 stings for iLoveSong, and the delivery format. Conversion is `python tools/wire_music.py`. **All 15 beds are generated, wired and playing; the 6 stings are not.** |
