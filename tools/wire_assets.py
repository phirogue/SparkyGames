...
UI_KEYED = {
    ...
    "ui_cloth_linen": 720,
    "ui_ribbon_band": 768,
    # The opponent's frame (owner 2026-08-17: "use ui_frame_portrait_thin
    # everywhere applicable"). Verified against this list's rule before adding:
    # the opaque bbox effectively fills the canvas, and the aperture is a real
    # hole (alpha 0, 86% of the canvas) rather than an opaque fill -- which
    # matters, because battle.gd draws the frame OVER the portrait and an
    # opaque centre would hide the enemy completely (law 22). Drawn at 396x410
    # in battle and in Testimony, so 512 on the long edge is plenty.
    #
